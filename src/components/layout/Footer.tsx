...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink-950 text-ink-400 py-10 mt-8 lg:pl-16 border-t border-ink-800">
      <div className="page-container">
        {/* Newsletter band */}
        <div className="mb-10 rounded-2xl bg-gradient-to-r from-brand-500/10 to-spice-500/10 border border-ink-800 p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
          ...
          >
            <Input
              ...
              className="bg-ink-800 border-ink-700 text-white placeholder:text-ink-500 focus:ring-brand-500 min-w-[220px]"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li><a href="/search" className="hover:text-brand-400 transition-colors">{t('allProducts', lang)}</a></li>
              <li><a href="/search?made_in_zanzibar=true" className="hover:text-brand-400 transition-colors">{t('madeInZanzibar', lang)}</a></li>
              <li><a href="/orders" className="hover:text-brand-400 transition-colors">{t('orders', lang)}</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-semibold text-sm mb-3">{t('selling', lang)}</h4>
            <ul className="space-y-2 text-xs">
              <li><a href="/register?type=seller" className="hover:text-brand-400 transition-colors">{t('openStore', lang)}</a></li>
              <li><a href="/seller/dashboard" className="hover:text-brand-400 transition-colors">{t('sellerDashboard', lang)}</a></li>
            </ul>
          </div>
          <div>
